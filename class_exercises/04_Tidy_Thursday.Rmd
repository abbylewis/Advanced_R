...
One especially interesting direction to explore may be the actual lyrics from her songs, which are stored as tibbles within the dataframe

```{r}
taylor_album_songs$lyrics[1]
```
