...
# Example for loop structure (you will need to modify this code before it will work)
...
#for (i in 1:length(numeric_columns)) { #loop through all of the columns specified above
  ...
  #recall that you can extract the data from a column by name using dt1[[column_name]]
