...
# OPTION 3: function
fix_nas <- function(df, na_val) { # Specify parameters ("formals")
  # BODY (essentially the same as for loop)
  for(column in colnames(df)){
    fixed_values <- df[column]
    fixed_values[fixed_values == na_val] <- NA
    df[column] <- fixed_values
  }
  # Return output
  return(df)
}
